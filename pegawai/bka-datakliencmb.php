...
if ($_SESSION['status'] == 'login') { ?>
  ...
  <title>BKA DataklienCB - Bapas Pekanbaru</title>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer ">
               <div>
                      <input type="submit" name="simpan" value="Tidak" class="btn btn-" style="width: 120px; float :right; margin-top :10px" href="../pegawai/bka-datakliencmb.php">
              </div>
              <div>
