...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="../pegawai/pegawai.php">
          ...
          ?>
            ...
            <tr align="center">
              ...
              <td>
                ...
                <div class="con">
                  <a class="bi bi-pencil-square bg-icon-primary " href="../pegawai/bka-statuscb.php?id_litmas=<?= $row['id_litmas'] ?>" style="margin-bottom: 5px; color :blue " role="button"></a>
                </div>
              </td>
            </tr>
          <?php
