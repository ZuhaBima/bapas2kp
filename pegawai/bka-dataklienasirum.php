    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="../pegawai/bka-dataklienasirum.php">Tambah Data Klien</a></li>
        </ol>
      </nav>
    </div>
    <!-- End Page Title -->
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer ">
               <div>
                      <input type="submit" name="simpan" value="Tidak" class="btn btn-" style="width: 120px; float :right; margin-top :10px" href="../pegawai/bka-dataklienasirum.php">
              </div>
              <div>
