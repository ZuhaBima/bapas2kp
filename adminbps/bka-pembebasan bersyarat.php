...
<a href="../adminbps/dashboard.html" class="logo d-flex align-items-center">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="../adminbps/bka-pembebasan bersyarat.html">Pembebasan Bersyarat</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <div class="mx-auto" style="width: 200px;">
      <a class="btn btn-primary" href="../adminbps/bka-dataklienpb.html" role="button">Tambah Data Klien</a>
    </div>
  </main><!-- End #main -->
