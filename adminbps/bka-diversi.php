        ...
        <tbody>
          ...
          ?>
            ...
            <tr align="center">
              ...
              <td>
                <a class="bi bi-pencil-square bg-icon-primary" href="../adminbps/bka-statusdiversi.php?id_litmas=<?= $row['id_litmas'] ?>"></a>
    </div>
    </td>
    <td>
      <a onclick="return confirm('Yakin menghapus data ini ?')" class="bi bi-trash-fill bg-icon-danger" style="color: red;" href="../adminbps/bka-hapusdiversi.php?id_litmas=<?= $row['id_litmas'] ?>"></a>
    </td>
    </tr>
  <?php
          }
